...
public class Sprweb20jpaJoinApplication {
	...
	public void initMembers() {
		...
		try {
			...
			// 반복처리로 쿼리를 실행
			for(String que:queries) { // list에 있는 내용을 하나씩 꺼낸다
		...
		/*
		 ...
		 // 40번 부서의 다른 정보를 이용해 직원 정보를 저장할 것이 아니먄 find 없이
		 // 부서 번호만 Dept 객체에 넣는다.
		 ...
		 */
		 ...
		 System.out.println("으디 부서야!! : " + dept10.getDname());
		 System.out.println("거가 어딘데!! : " + dept10.getLoc());
		 System.out.println("몇명이야!! : " + dept10.getList().size());
