...
//	
	List<Jikwon> findByjikwon_jikContaining(String svalue);  // 검색어가 포함된 like '%검색어%'
	List<Jikwon> findByjikwon_jikStartingWith(String svalue);  // 검색어로 시작되는 like '검색어%'
	List<Jikwon> findByjikwon_jikEndingWith(String svalue); //검색어로 끝나는 like '%검색어'
